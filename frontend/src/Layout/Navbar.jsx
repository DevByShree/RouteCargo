        ...
        <nav className="w-full bg-white border-b border-gray-200 px-5 mt-1">
            <div className="flex items-center justify-between px-6 lg:px-10">
                ...
                <div className="flex items-center gap-3">
                    <button className="py-5 px-2 text-sm font-medium text-blue-600 hover:text-blue-700 transition">
                        Login
                    </button>
                    <button className="py-2.5 px-5 text-sm text-white font-semibold rounded-lg hover:bg-blue-700 transition bg-blue-600">
                        Sign Up
                    </button>
                </div>
            </div>
